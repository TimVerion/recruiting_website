...
//		view.setViewName("user/MyJsp");
	...
	public ModelAndView  saveUser(String username,String pwd,Integer status,HttpServletRequest request) {
		ModelAndView view = new ModelAndView();
		User user =new User();
	 ...
	 * List<JobDto> list = jobService.findAllJob();
		System.out.println(list);
		view.addObject("param", list);*/
